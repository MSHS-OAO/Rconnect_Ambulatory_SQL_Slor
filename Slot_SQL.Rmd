...
base_slot_query <- glue("CREATE TABLE AMBULATORY_BASE_SLOT_TABLE AS
                        ...
                        GROUP BY DEPARTMENT_ID, DEPARTMENT_NAME, PROV_NM_WID, PROV_ID, SLOT_DATE, TO_CHAR(SLOT_DATE, 'yyyy-mm');")
...
slot_table_quary <- glue("CREATE TABLE AMBULATORY_SLOT_TABLE AS
                            ...
                            (
                              ...
                              FROM
                              (
                                SELECT s.*, b.DEPT_SPECIALTY_NAME, b.NPI, b.VISIT_PROV_STAFF_RESOURCE_C, b.SCHEDULED_MINS,                                                                           b.ARRIVED_MINS
                                FROM
